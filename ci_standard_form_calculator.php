...
Version: 1.0.0
Author: Standard Form Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Standard Form Calculator by www.calculator.io";

function display_calcio_ci_standard_form_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_standard_form_calculator', 'display_calcio_ci_standard_form_calculator' );